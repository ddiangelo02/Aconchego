                ...
                <section class="container mx-auto px-gutter max-w-5xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="card-plan">
                            ...
                            <div>
                                <h3 class="font-heading text-xl font-bold text-brand-brown-dark">Plano Mensal</h3>
                        ...
                        <div class="card-plan-highlight relative overflow-hidden">
                            ...
                            <div>
                                <h3 class="font-heading text-xl font-bold text-brand-brown-dark">Plano Anual</h3>
